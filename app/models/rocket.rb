class Rocket < ApplicationRecord
  ...
  validates :name, :description, :height, :mass, :variant, :costperlaunch, :rateofsuccess, presence: true
  ...
  validates :costperlaunch, :rateofsuccess, numericality: { only_integer: true }
